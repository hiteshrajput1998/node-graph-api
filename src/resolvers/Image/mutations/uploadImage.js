...
export default async (_, { file, description, tags }, context, info) => {
    logger.log(`file: ${logger.stringify(file)}`);
    logger.log(`description: ${logger.stringify(description)}`);
    logger.log(`tags: ${logger.stringify(tags)}`);
